...
class TestZoo(unittest.TestCase):
    ...
    def test_invalid_ticket_price(self):
        self.assertEqual(self.zoo.get_ticket_price(-5), "Invalid Age")

    def test_invalid_ticket_price_1(self):
        self.assertEqual(self.zoo.get_ticket_price(-1), "Invalid Age")

    def test_childe_ticket_price_1(self):
        self.assertEqual(self.zoo.get_ticket_price(0), 50)
    
    def test_childe_ticket_price_2(self):
        self.assertEqual(self.zoo.get_ticket_price(1), 50)
    
    def test_childe_ticket_price_3(self):
        self.assertEqual(self.zoo.get_ticket_price(11), 50)
    
    def test_childe_ticket_price_4(self):
        self.assertEqual(self.zoo.get_ticket_price(12), 50)
    
    def test_teen_ticket_price_1(self):
        self.assertEqual(self.zoo.get_ticket_price(13), 100)
    
    def test_teen_ticket_price_2(self):
        self.assertEqual(self.zoo.get_ticket_price(14), 100)
    
    def test_teen_ticket_price_3(self):
        self.assertEqual(self.zoo.get_ticket_price(19), 100)
    
    def test_teen_ticket_price_4(self):
        self.assertEqual(self.zoo.get_ticket_price(20), 100)
    
    def test_adult_ticket_price_1(self):
        self.assertEqual(self.zoo.get_ticket_price(21), 150)
    
    def test_adult_ticket_price_2(self):
        self.assertEqual(self.zoo.get_ticket_price(22), 150)
    
    def test_adult_ticket_price_3(self):
        self.assertEqual(self.zoo.get_ticket_price(59), 150)
    
    def test_adult_ticket_price_4(self):
        self.assertEqual(self.zoo.get_ticket_price(60), 150)
    
    def test_old_ticket_price_1(self):
